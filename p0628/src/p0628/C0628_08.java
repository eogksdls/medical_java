...
//		
//		// iterator()는 일회용. 한 번 호출되면, 2번 출력하려면 다시 선언
//		Iterator it = set.iterator(); 
//		while(it.hasNext()) { //현재 객체가 있는지 확인
//			Person p = (Person)it.next(); //객체 1개 가져오기
//			System.out.println(p.name); //이름만 출력
//		}
//		System.out.println();
//		
//		it = set.iterator();
...
//		while (it2.hasNext()) {
////			Object o = (Person) it2.next(); //객체 1개 가져오기
...
//		set.add("4");
//		
//		System.out.println(set);  //중복되는 문자는 모두 제거해서 출력됨
//		
//		//int
//		Object[] objArr = {"1",new Integer(1),"2","2","3","3","4","4","4"};
//		Set set = new HashSet(); //중복되는 문자 제거
//		
